...
// ==============================================================================
    test('se a função retorna o objeto correto para o parâmetro Arya.', () => {
      expect(getCharacter('Arya')).toStrictEqual(arya); //testar objetos https://jestjs.io/pt-BR/docs/expect#tostrictequalvalue
    });
...
// ==============================================================================    
    test('se o parâmetro não é Case Sensitive, ou seja, independente de conter letras maiúsculas ou minúsculas retorna o mesmo objeto relativo a ele.', () => {
      expect(getCharacter('ArYa')).toStrictEqual(arya);
    });

// ==============================================================================
    test('se ao passar um nome que não está na tabela, a função retorna undefined.', () => {
      expect(getCharacter('Richard')).toBeUndefined();
    });
